...
### 3.1 단계별 상세 요구사항 참조
상세 기능 명세 및 구현 로드맵은 아래 문서를 참조하십시오. AI Agent는 컨텍스트 최적화 및 토큰 절약을 위해 필요 시에만 해당 경로의 내용을 참조합니다.

*   **Phase 01:** [docs/Phase 01/prd.md][def01] (초기 이관 및 기본 조회)
*   **Phase 02:** [docs/Phase 02/prd.md][def02] (증분 동기화 및 대시보드 고도화)
...
[def01]: ./Phase%2001/prd01.md
[def02]: ./Phase%2002/prd02.md